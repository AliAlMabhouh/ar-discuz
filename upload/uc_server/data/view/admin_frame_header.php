...
<div class="mainhd">
	...
	<div class="uinfo">
		<p> مرحبا , <em><?php echo $username;?></em> [ <a href="admin.php?m=user&a=logout" target="_top">تسجيل الخروج</a> ]</p>
		<?php if($admincp) { ?>
			<p id="others"><a href="#" class="othersoff" onclick="showmenu(this);">لوحة ادارة اخرى</a></p>
