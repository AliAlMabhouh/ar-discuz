...
document.writeln('<option value="0"' + google_default_0 + '>بحث في الويب</option>');
document.writeln('<option value="1"' + google_default_1 + '>بحث في الموقع</option>');
document.writeln('</select>');
document.writeln('&nbsp;<button type="submit" name="sa" value="true">بحث</button>');
