...
/*vot*/		return 'أدخل إسم المستخدم:<br /><input type="text" id="atkeyword" style="width:240px" value="" class="px" onkeydown="atEnter(event, \'atListSet\')" onkeyup="atFilter(this.value, \'at_list\',\'atListSet\',event, true);" /><div class="p_pop" id="at_list" style="width:250px;"><ul><li>@صديق, يمكنك تذكيره بهذه المشاركة </li></ul></div>';
	} else {
		if($('atkeyword').value) {
...
/*vot*/	$('at_menu').innerHTML = '<img src="' + IMGDIR + '/loading.gif" class="vm"> الرجاء الإنتظار';
}
...
/*vot*/			$(id).innerHTML = '<ul>' + newlist + '<li class="xg1">@صديق, يمكنك تذكيره بهذه المشاركة </li></ul>';
		} else {
