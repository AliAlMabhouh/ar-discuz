...
(
	...
	'feed_poll'		=> '{actor} قام بإنشاء إستطلاع جديد',//'{actor} ??????',
	...
	'feed_showcredit_self'	=> '{actor} أنفق {credit} نقطة لظهور نفسه <a href="home.php?mod=space&do=top">أعلى القائمة</a>',//'{actor} ?????? {credit} ?,?????<a href="home.php?mod=space&do=top" target="_blank">?????</a>????',
	'feed_doing_title'	=> '{actor} يقول: {message}',//'{actor}:{message}',
	'feed_friend_title'	=> '{actor} و {touser} أصبحا أصدقاء',//'{actor} ? {touser} ?????',



	'feed_click_blog'	=> '{actor} أرسل  &quot;{click}&quot; إلى  مدونة {touser}  ({subject})',//'{actor} ????“{click}”? {touser} ??? {subject}',
	'feed_click_thread'	=> '{actor} أرسل &quot;{click}&quot; إلى موضوع {touser}  ({subject})',//'{actor} ????“{click}”? {touser} ??? {subject}',
	'feed_click_pic'	=> '{actor} أرسل &quot;{click}&quot; إلى صورة  {touser} ',//'{actor} ????“{click}”? {touser} ???',
	'feed_click_article'	=> '{actor} أرسل &quot;{click}&quot; إلى مقالة  {touser}  ({subject}*',//'{actor} ????“{click}”? {touser} ??? {subject}',


	'feed_task'		=> '{actor} أكمل مهمة  {task}',//'{actor} ??????? {task}',
	'feed_task_credit'	=> '{actor} أكمل مهمة {task} وحصل على  {credit} نقطة',//'{actor} ??????? {task},??? {credit} ?????',

	'feed_profile_update_base'	=> '{actor} حدث معلوماته الشخصية',//'{actor} ??????????',
	'feed_profile_update_contact'	=> '{actor} حدث معلومات الإتصال الخاصة به',//'{actor} ??????????',
	...
	'feed_add_attachsize'		=> '{actor} أنفق {credit} نقطة لتوسيع حجم ملفه الشخصي  ({size}). ويمكنه الآن رفع بيانات أكثر. (<a href="home.php?mod=spacecp&ac=credit&op=addsize">أنا أريد ذلك أيضاً!</a>)',//'{actor} ? {credit} ?????? {size} ????,??????????(<a href="home.php?mod=spacecp&ac=credit&op=addsize">?????</a>)',

	'feed_invite'			=> '{actor} دعا {username}, ولقد أصبحا صديقان',//'{actor} ????,? {username} ?????',

	'magicuse_thunder_announce_title'	=> '<strong>{username} إستخدم &quot;دعامة الرعد&quot;</strong>',//'<strong>{username} ???“????”</strong>',
	...
	'feed_thread_poll_title'	=>		'{actor} قام بإنشاء إستطلاع',//'{actor} ??????',
	...
	'feed_thread_goods_message_1'	=> '<b>{itemname}</b><br />السعر: {itemprice}  لكل إضافية (???) {itemcredit} {creditunit}',//'<b>{itemname}</b><br />?? {itemprice} ? ?? {itemcredit}{creditunit}',
	...
	'feed_thread_debate_title'	=>		'{actor} قام بإنشاء تحدي جديد',//'{actor} ??????',
