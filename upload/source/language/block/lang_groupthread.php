...
(
	...
	'groupthread_fids_comment'	=> 'إستخدام "," للفصل بين أرقام المجموعات',//'指定群组ID，多个ID之间用 , 分割',
	'groupthread_gtids'		=> 'أقسام المجموعة',//'群组分类',
	'groupthread_gtids_comment'	=> 'إختر أقسام المجموعات , يمكنك إستخدام CTRL',//'选择群组分类',
	'groupthread_uids'		=> 'أرقام الكتاب',//'楼主UID',
	'groupthread_uids_comment'	=> 'إستخدم الفاصلة للفصل بين أرقام الكتاب.',//'指定主题作者ID，多个ID之间用 , 分割',
	'groupthread_keyword'	=> 'عنوان الكلمات الدلالية',
	'groupthread_keyword_comment'	=> 'قم بإدخال عنوان الكلمات الدلالية',
	...
	'groupthread_picpre_comment'		=> 'قم بإختيار أيقونة البادئة , أتركه فارغا لتعطيلها',//'设置是否在主题前加入图片形式的图标，输入图片的 URL (绝对或相对)地址即可，留空为不显示前缀图标',
	...
	'groupthread_sortids_comment'	=> 'حدد أنواع خاصة من المواضيع . ملاحظة : حدد الكل أو لا تحدد الكل لتعطيل التصفية',//'设置特定分类信息的主题。注意: 全选或全不选均为不进行任何过滤',
	...
	'groupthread_groupthreadort_comment'	=> 'إختر من هنا إذا كنت ترغب في أن تعرض البادءة قبل إسم الموضوع في قائمة المواضيع في القسم',//'设置是否在主题列表中，给分类信息的主题前加上分类信息名称',
	...
	'groupthread_digest_comment'		=> 'تصفية المميز , أختارها كلها أو لا تختر شيئا',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'groupthread_stick'		=> 'تصفية حسب التثبيت',//'置顶主题过滤',
	'groupthread_stick_comment'	=> 'تصفية المميز , أختارها كلها أو لا تختر شيئا',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'groupthread_special'		=> 'تصفية حسب المواضيع الخاصة',//'特殊主题过滤',
	'groupthread_special_comment'	=> 'تصفية حسب المواضيع الخاصة , إختارها كلها أو لا تختر شيئا',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'groupthread_special_reward_comment'	=> 'حدد الأنواع الخاصة بالجوائز',//'设置特定类型的悬赏主题',
	'groupthread_picrequired'		=> 'مطلوب صورة مرفقة',//'必须含图片附件',
	'groupthread_picrequired_comment'	=> 'إختر فقط المواضيع التي تحتوي على صور',//'设置是否只显示含有图片附件的主题',
	...
	'groupthread_recommend_comment'		=> 'عرض فقط المواضيع التي ينصح بها',//'设置是否只显示推荐的主题',
