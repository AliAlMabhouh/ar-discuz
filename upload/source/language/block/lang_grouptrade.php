...
(
	...
	'grouptrade_gtids_comment'	=> 'إختر أقسام المجموعات , يمكنك إستخدام CTRL',//'设置群组所在分类，可以按住 CTRL 多选，全选或全不选均为不做限制',
	...
	'grouptrade_tids_comment'	=> 'قم بوضع أرقام المواضيع , إفصل بينها بفاصلة',//'设置要指定显示的主题 tid ，多个 tid 请用半角逗号“,”隔开。注意: 留空为不进行任何过滤',
	...
	'grouptrade_sortids_comment'		=> 'حدد أنواع خاصة من المواضيع . ملاحظة : حدد الكل أو لا تحدد الكل لتعطيل التصفية',//'设置特定分类的主题。注意: 全选或全不选均为不进行任何过滤',
	'grouptrade_sortids_all'	=> 'كل الأقسام',//'全部的分类信息',
	'grouptrade_digest'		=> 'تصفية حسب التمييز',//'精华主题过滤',
	'grouptrade_digest_comment'	=> 'تصفية المميز , أختارها كلها أو لا تختر شيئا',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'grouptrade_stick_comment'	=> 'تصفية المميز , أختارها كلها أو لا تختر شيئا',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'grouptrade_special_comment'	=> 'تصفية حسب المواضيع الخاصة , إختارها كلها أو لا تختر شيئا',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'grouptrade_special_reward_comment'	=> 'حدد الأنواع الخاصة بالجوائز',//'设置特定类型的悬赏主题',
	...
	'grouptrade_recommend_comment'	=> 'عرض فقط المواضيع التي ينصح بها',//'设置是否只显示推荐的主题',
	'grouptrade_orderby'		=> 'ترتيب حسب',//'主题排序方式',
	'grouptrade_orderby_comment'	=> 'إختر الترتيب المناسب',//'设置以哪一字段或方式对主题进行排序',
	...
	'grouptrade_orderby_hours_comment'	=> 'تحديد وقت محدد للعرض بـ',//'指定时间内浏览次数倒序排序的时间值',
