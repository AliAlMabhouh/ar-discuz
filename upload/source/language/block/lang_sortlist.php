...
(
	...
	'sortlist_fids_comment'		=> 'إختر المنتديات الهدف , يمكنك إستعمال CTRL',//'设置允许参与新帖调用的版块，可以按住 CTRL 多选，全选或全不选均为不做限制',
	...
	'sortlist_typeids_all'		=> 'كل انواع المواضيع',//'全部的主题分类',
	'sortlist_sortids'		=> 'أنواع الترتيب(الأقسام?)',//'分类信息',
	'sortlist_sortids_comment'	=> 'إختار أنواع الترتيب , ملاحظة : إختر الكل أو لا شيء',//'设置特定分类信息的主题。注意: 全选或全不选均为不进行任何过滤',
	'sortlist_sortids_all'		=> 'كل الأقسام',//'全部的分类信息',
	'sortlist_digest'		=> 'تصفية حسب المميز',//'精华主题过滤',
	'sortlist_digest_comment'	=> 'إختار المميز , ملاحظة : إختر الكل أو لا شيء',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'sortlist_stick_comment'	=> 'إختار المميز , ملاحظة : إختر الكل أو لا شيء',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'sortlist_special_comment'	=> 'إختار المواضيع الخاصة , ملاحظة : إختر الكل أو لا شيء',//'设置特定的主题范围。注意: 全选或全不选均为不进行任何过滤',
	...
	'sortlist_recommend_comment'	=> 'عرض فقط المواضيع المستحسنة',//'设置是否只显示推荐的主题',
	'sortlist_orderby'		=> 'ترتيب حسب',//'主题排序方式',
	'sortlist_orderby_comment'	=> 'إختر الترتيب المناسب',//'设置以哪一字段或方式对主题进行排序',
	...
	'sortlist_orderby_hours_comment'	=> 'إختر وقت محدد لعرض المواضيع فيه',//'指定时间内浏览次数倒序排序的时间值',
);
