...
(
	'discuz_lang'		=> 'ملحق',
	'seccode' => 'رمز التحقق',
	'seccode_update' => 'تحديث كود التحقق',
	'seccode_player' => '<span style="padding:2px"><img border="0" style="vertical-align:middle" src="static/image/common/seccodeplayer.gif" /> <a href="javascript:;" onclick="window.document.seccodeplayer_{idhash}.SetVariable(\'isPlay\', 1)">تشغيل كود التحقق</a></span>',
	'secqaa' => 'التحقق من الإجابات',
	'mobileoem_creditrule' => 'التسجيل المحمول',
	'contact'	=> 'مراسلة :',
	'anonymous'		=> 'مجهول',//'匿名',
	'anonymoususer'	=> 'مجهول',
	'guestuser'	=> 'زائر',
	...
	'connectguest_message_replace' => array('you need to <a href="member.php?mod=connect" class="xi2">Improve the account information</a> or <a href="member.php?mod=connect&ac=bind" class="xi2">绑定已有帐号</a> ', '先 <a href="member.php?mod=connect" class="xi2">完善帐号信息</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">绑定已有帐号</a> '),
	'connectguest_message_mobile_search' => array('لم يتم تسجيل الدخول', 'تم تسجيل الدخول'),
	'connectguest_message_mobile_replace' => 'Perfect information or to bind existing account in the computer version.',
