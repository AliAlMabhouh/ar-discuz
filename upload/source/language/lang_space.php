...
$lang = array(
	...
	'before'		=> ' مضت ',//'前',
	'minute'		=> ' دقيقة ',//'分钟',
	'viewthread_userinfo_digestposts' => 'جوهر',
	'viewthread_userinfo_feeds' => 'الأخبار',
	'viewthread_userinfo_privacy' => 'الخصوصية',
	'second'		=> ' ثانية ',//'秒',
	'now'			=> ' الآن ',//'现在',
	'dot'			=> '. ',//'、',
	'poll'			=> ' إستطلاع ',//'投票',
...
/*vot*/ 	'blockdata' => array(
	...
	'wall_form'		=> '<div class="space_wall_post">
				<form action="home.php?mod=spacecp&ac=comment" id="quickcommentform_{uid}" name="quickcommentform_{uid}" method="post" autocomplete="off" onsubmit="ajaxpost(\'quickcommentform_{uid}\', \'return_commentwall_{uid}\');doane(event);">
					...
					<input type="hidden" name="idtype" value="uid" />
							<input type="hidden" name="commentsubmit" value="true" />' : ($_G['connectguest'] ? '<div class="pt hm">تحتاج إلى <a href="member.php?mod=connect" class="xi2">تحسين معلومات الحساب</a> أو <a href="member.php?mod=connect&ac=bind" class="xi2">حساب آخر متاح</a> حتى يمكنك الرد </div>' : '<div class="pt hm">يجب عليك تسجيل الدخول لتستطيع المواصلة<a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href)" class="xi2">تسجيل دخول</a> | <a href="member.php?mod='.$_G['setting']['regname'].'" class="xi2">'.$_G['setting']['reglinkname'].'</a></div>')).'
	...
	'block_profile_update'	=> 'تحديث الملف',//'更新资料',
		'block_profile_follow' => 'عرض التتبع',
	...
	'viewthread_userinfo_credits'	=> 'الأرصدة',
	...
	'viewthread_userinfo_sellercredit' => 'رصيد كمشتري',
	'viewthread_userinfo_buyercredit' => 'رصيد كبائع',
	'viewthread_userinfo_follower' => 'عدد المتتبعين',
	'viewthread_userinfo_following' => 'الاشتراكات',
	'follow_view_follow' => 'التغريدات',
	'follow_view_special' => 'تتبع خاص',
	'follow_view_other' => 'صفحة التغريدات',
	'follow_view_feed' => 'تغريدات {who}',
	'follow_view_thread' => 'موضوع {who}',
	'follow_view_reply' => ' رد {who}',
	'follow_view_profile' => 'المعلومات الشخصي ل{who}',
	'follow_view_type_feed' => 'تغريدات',
	'follow_view_type_thread' => 'موضوع',
	'follow_view_type_reply' => 'رد',
	'follow_view_type_profile' => 'معلومات شخصية',
	'follow_view_type_follower' => 'قائمة المتتبعين',
	'follow_view_type_following' => 'تتبع الاعضاء',
	'follow_view_my_follower' => 'متتبعي',
	'follow_view_my_following' => 'أتتبع الاعضاء',
	'follow_view_do_follower' => 'متتبعي',
	'follow_view_do_following' => 'يتتبع الاعضاء',
	'follow_view_fulltext' => '...عرض النص الكامل',
	'follow_retract' => 'تراجع',
	'follow_click_play' => 'انقر للعب',
	'follow_cancle_follow' => 'إلغاء التتبع',
	'follow_follow_ta' => 'تتبع العضو',
