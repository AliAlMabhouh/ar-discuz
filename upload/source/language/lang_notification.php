...
(
	...
	'thread_hidden' => 'الموضوع الخاص بك <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> تم إخفاءه بسبب إعتباره كبريد مزعج &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرض &rsaquo;</a>',
	...
	'reason_live_update' => 'الموضوع الخاص بك <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> تم جعله من قبل {actor} كموضوع حي <div class="quote"><blockquote>{reason}</blockquote></div>',
	'reason_live_cancle' => 'الموضوع الخاص بك <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> تم إلغاءه من قبل {actor} من خاصية الموضوع الحي <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'share_thread'		=> '{actor} قام بنشر موضوعك  <a href="{url}" target="_blank">{subject}</a>.',//'{actor} 分享了你的帖子 <a href="{url}" target="_blank">{subject}</a>',
	...
	'friend_request'	=> '{actor} يطلب منك قبول طلب الصداقة بينك وبينه : {note}&nbsp;&nbsp;<a onclick="showWindow(this.id, this.href, \'get\', 0);" class="xw1" id="afr_{uid}" href="{url}">موافق</a>',//'{actor} 请求加你为好友{note}&nbsp;&nbsp;<a onclick="showWindow(this.id, this.href, \'get\', 0);" class="xw1" id="afr_{uid}" href="{url}">批准申请</a>',
	...
	'modthreads_delete'	=> 'موضوعك {threadsubject} لم يتم الموافقة عليه, تم حذفه! ',//'你发表的主题 {threadsubject} 没有通过审核，现已被删除！<div class="quote"><blockquote>{reason}</blockquote></div>',

	'modthreads_validate'	=> 'موضوعك <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{threadsubject}</a> تم الموافقة عليه! &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">إضغط هنا لرؤيته;</a> ',//'你发表的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{threadsubject}</a> 已经审核通过！ &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

 	'modthreads_delete_reason' => 'موضوعك {threadsubject} لم يتم الموافقة عليه, وتم حذفه! <div class="quote"><blockquote>{reason}</blockquote></div>',//'您发表的主题 {threadsubject} 未通过审核，现已被删除！<div class="quote"><blockquote>{reason}</blockquote></div>',

	'modreplies_delete'	=> 'لم يتم الموافقة على ردك, لقد تم حذفه! <p class="summary">المحتوى: <span>{post}</span></p> ',//'你发表回复没有通过审核，现已被删除！ <p class="summary">回复内容：<span>{post}</span></p> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'modreplies_validate'	=> 'تم الموافقة على ردك! &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">إضغط هنا لرؤيته</a> <p class="summary">المحتوى: <span>{post}</span></p> ',//'你发表的回复已经审核通过！ &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">查看 &rsaquo;</a> <p class="summary">回复内容：<span>{post}</span></p> <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'addfunds'		=> 'طلبك لاعادة تعبئة الرصيد تم بنجاح, وتم إضافة مبلغ مماثل إلى رصيدك
				...
				<p class="summary">الرصيد الوارد : <span>{value}</span></p>',
	...
	'recommend_note_post' => 'تهانينا，مشاركتك <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> تم تحريرها بما يناسب شروط المنتدى',
	...
	'activity_notice'	=> '{actor} قام بالانضمام إلى  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>, الرجاء  &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرضها</a>',//'{actor} 申请加入你举办的活动 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>，请审核 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
	...
	'reward_bestanswer_moderator'	=> 'ردفك في موضوع الطلب  <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> تم اختياره كأفضل إجابة &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">عرض &rsaquo;</a>',//'你在悬赏主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的回复被选为最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
	...
	'task_reward_medal_forever'	=> 'تهانينا لإكمال مهامك بنجاح: <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>, الحصول على وسام <a href="home.php?mod=medal" target="_blank">{rewardtext}</a> Permanent',//'恭喜你完成任务：<a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>，获得勋章 <a href="home.php?mod=medal" target="_blank">{rewardtext}</a> 永久有效',
	...
	'blog_invite' => '{actor} يدعوك لمشاهدة  <a href="home.php?mod=space&uid={uid}&do=blog&id={blogid}" target="_blank">{subject}</a> &nbsp; <a href="home.php?mod=space&uid={uid}&do=blog&id={blogid}" target="_blank" class="lit">عرض &rsaquo;</a>',
	'article_invite' => '{actor} يدعوك لمشاهدة <a href="portal.php?mod=view&aid={aid}" target="_blank">{subject}</a> &nbsp; <a href="portal.php?mod=view&aid={aid}" target="_blank" class="lit">عرض &rsaquo;</a>',
	...
	'profile_verify_pass_refusal'	=> 'للأسف, تم رفض البيانات المقدمة  ({verify})  ',//'很遗憾，你填写的{verify}资料审核被拒绝了',
	...
	'member_ban_visit' => 'لقد تعرضت أنت يا  {user} لحظر الوصول لفترة ：{day} يوم (0：يدل على حظر نهائي)，سبب منع الوصول ：{reason}',
	'member_ban_status' => 'لقد تعرضت يا  {user} للقفل，والسبب：{reason}',
	'member_follow' => 'نشر الأعضاء المتابعون {count} تغريدة. <a href="home.php?mod=follow">ألقي نظرة</a>',
	...
	'report_change_credits'		=> '{actor} تعامل مع تقريرا خاص بك, رصيدك {creditchange}',
	'at_message' => '<a href="home.php?mod=space&uid={buyerid}" target="_blank">{buyer}</a> في الموضوع : <a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">{subject}</a>  المذكورة في <div class="quote"><blockquote>{message}</blockquote></div><a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">مشاهدة</a>。',
	...
	'invite_collection' => '{actor} يدعوك للمشاركة في ألبوم المشاركات التالي  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> .<br /> <a href="forum.php?mod=collection&action=edit&op=acceptinvite&ctid={ctid}&dateline={dateline}">قبول الدعوة</a>',
	'collection_removed' => 'Are you involved in the maintenance of Amoy album  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> {Actor} Turn off.',
	'exit_collection' => 'You have to exit to maintain Amoy album  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> .',
	'collection_becommented' => 'الألبوم الخاص بك : <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> تلقى تعليق جديد',
	'collection_befollowed' => 'الألبوم الخاص بك :  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> تم تتبعه من قبل أعضاء جدد !',
	'collection_becollected' => 'لقد تم وضع موضوعك <a href="forum.php?mod=viewthread&tid={tid}">{threadname}</a> في ألبوم مشاركات   <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> ',
