...
(
	...
	'moderate_member_invalidate'	=> 'تم الرفض',//'否决',
	'moderate_member_delete'	=> 'حذف',//'删除',
	'moderate_member_validate'	=> 'موافقة',//'通过',


	'get_passwd_subject'	=> 'إستعادة كلمة المرور',//'取回密码说明',
	'get_passwd_message'	=> '
<p>{username},
...
----------------------------------------------------------------------</p>
<p>إذا لم تطلب ارجاع كلمة المرور أو التذكير بها أو أنك غير مسجل بالمنتدى,
الرجاء تجاهل هذه الرسالة وحذفها.
إذا كنت طلب ارجاع كلمة المرور واعادة تعيينها,
يجب عليك قراءة المحتوى التالي.</p>
<p>
----------------------------------------------------------------------<br />
<strong>تعليمات إستعادة كلمة المرور</strong><br />
----------------------------------------------------------------------</p>
</p>
...
{siteurl}</p>',
	...
	'email_register_subject' =>	'رابط التسجيل بالمنتدى',
...
{siteurl}</p>',
	...
	'add_member_subject'	=> 'تم اضافك كعضو جديد في منتدانا',//'你被添加成为会员',
	'add_member_message'	=> '
{newusername},
هذه الرسالة تم إرسالها من  {bbname}.

أنا {adminusername}, اداري في منتدى  {bbname}. أنت استقبلت هذه ا لرسالة بسبب إنضمامك كعضو لدينا
...
{siteurl}',
	...
	'birthday_subject'	=> 'عيد ميلاد سعيد!',//'祝你生日快乐',
	'birthday_message'	=> '
{username},
...
{siteurl}',
	...
	'email_to_friend_subject'	=> '{$_G[member][username]} يدعوك لزيارة : $thread[subject]',//'{$_G[member][username]} 推荐给你: $thread[subject]',
...
$_G[siteurl]',
	...
	'email_to_invite_subject'	=> 'صديقك {$_G[member][username]} يدعوك للتسجيل في  {$_G[setting][bbname]}',//'你的朋友 {$_G[member][username]} 发送 {$_G[setting][bbname]} 论坛注册邀请码给你',
...
من منتدانا أرسل لك كود دعوة, للسماح لك بالتسجيل بمنتدانا .
...
معلومات التسجيل الخاصة بك غير مكتملة ،
 ...
 إستكمال تسجيل المعلومات الخاصة بك،
 ثم قدم.
</p>
...
طلبك مرفوض  تماما ، تم إزالة حسابك  من قاعدة البيانات.
