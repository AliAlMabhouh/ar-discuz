...
if(@file_exists(DISCUZ_ROOT.'./install/index.php') && !DISCUZ_DEBUG) {
	...
	if(@file_exists(DISCUZ_ROOT.'./install/index.php')) {
		dexit('الرجاء حذف الملف install/index.php لدواعي أمنية');
	}
}
...
showtablefooter();
showtableheader('home_discuzar_news', 'nobottom fixpadding');
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont"'), array(
		'<iframe src="http://www.ar-discuz.net/discuzar-news.htm" width="850" height="110" frameborder="0">
</iframe> '
));
...
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont"'), array(
	...
	'Discuz! '.DISCUZ_VERSION.' Release '.DISCUZ_RELEASE.' <a href="http://faq.comsenz.com/checkversion.php?product=Discuz&version='.DISCUZ_VERSION.'&release='.DISCUZ_RELEASE.'&charset='.CHARSET.'&dbcharset='.$dbcharset.'" class="lightlink2 smallfont" target="_blank">'.cplang('home_check_newversion').'</a> <a href="http://www.comsenz.com/purchase/discuz/" class="lightlink2 smallfont" target="_blank">الدعم والخدمات المهنية</a> <a href="http://idc.comsenz.com" class="lightlink2 smallfont" target="_blank">إستضافه ديسكاز مخصصه</a>'
));
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont"'), array(
	cplang('home_discuzar_version'),
	'Arabic Discuz! Version Rev #'.DISCUZAR_REV.' <a href="http://www.ar-discuz.net/thread-505-1-1.html" class="lightlink2 smallfont" target="_blank">تحميل آخر إصدار معرب من هنا</a>'
));
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont"'), array(
...
showtableheader('home_discuzar_team', 'fixpadding');
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont team"'), array(
	cplang('home_discuzar_team'),
	'
	 <a href="http://www.ar-discuz.net/home.php?mod=space&uid=109" class="lightlink2 smallfont" target="_blank">zininabil</a>
	 <a href="http://www.ar-discuz.net/home.php?mod=space&uid=90" class="lightlink2 smallfont" target="_blank">عاشق الخطورة</a>
	 <a href="http://www.ar-discuz.net/home.php?mod=space&uid=1" class="lightlink2 smallfont" target="_blank">DrAM</a>
	 <a href="http://www.ar-discuz.net/home.php?mod=space&uid=38" class="lightlink2 smallfont" target="_blank">startop</a>
	 <a href="http://www.ar-discuz.net/home.php?mod=space&uid=79" class="lightlink2 smallfont" target="_blank">Seto Steel - في الفريق سابقا</a>
	 <a href="http://www.ar-discuz.net/home.php?mod=space&uid=94" class="lightlink2 smallfont" target="_blank">مـــراد</a>
	 <a href="http://www.ar-discuz.net/home.php?mod=space&uid=128" class="lightlink2 smallfont" target="_blank">Ractain</a>
	 '
));
showtablefooter();
...
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight"'), array(
	...
	'<a href="http://www.comsenz.com" class="lightlink2" target="_blank">موقع الشركة</a>,
