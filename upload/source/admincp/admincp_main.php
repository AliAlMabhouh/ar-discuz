...
<div class="mainhd">
<div class="uinfo1"><p class="btnlink"><a href="index.php" target="_blank">$header_bbs</a></p></div>
<div class="uinfo" id="frameuinfo">
</div>
<a href="$basescript?frames=yes&action=index" class="logo"></a>
<div class="navbg"></div>
<div class="nav">
<ul id="topmenu">
...
<div class="copyright">
	...
	<p>&copy; 2001-{$year}, <a href="http://www.comsenz.com/" target="_blank">Comsenz Inc.</a></p>
	<p><a href="http://www.ar-discuz.net" target="_blank">Arabic Rev</a> #{$_G['setting']['arabic_rev']}</p>
</div>
...
<script type="text/JavaScript">
	...
	function initCpMap() {
		...
		var width = 720;
		s = '<div class="cnote" style="width:' + width + 'px"><span class="right"><a href="###" class="flbc" onclick="hideMenu();return false;"></a></span><h3 class="right">$lang[admincp_maptitle]</h3></div>' +
