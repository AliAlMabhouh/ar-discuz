...
<title>مدير إستعادة البيانات</title>
<style type="text/css">
...
.bodydiv { margin:40px auto 0; width:960px; text-align:right; border:solid #86B9D6; border-width:5px 1px 1px; background:#FFF; }
h1 { font-size:18px; margin:1px 0 0; line-height:50px; height:50px; background:#E8F7FC; color:#5086A5; padding-right:10px; }
...
table { border-collapse:collapse; margin-bottom:20px; }
	th { text-align:right; color:#5086A5; }
	th, td { padding:5px 2px; border-bottom:1px dashed #DDD; }
	.subtb { padding-right:20px; }
...
<div class="bodydiv">
	<h1>
		<div style="direction:rtl; float: right; margin-right: 5px;">مدير إستعادة البيانات
		<span> &nbsp; في حال واجهت أي مشاكل لا تبخل بزيارة <a href="http://www.ar-discuz.net" target="_blank">http://www.ar-discuz.net</a></span><div>
	</h1>
	<div class="main">
EOT;
}
...
function show_footer($quit = true) {
	...
	<div id="footer"><a href="http://www.comsenz.com/">Comsenz</a> Inc. &copy; 2001 - 2013  - Arabic By <a href="http://www.ar-discuz.net/">Ar-Discuz.Net</a></div>
</div>
</body>
</html>
EOT;
...
function show_msg($message, $url_forward = '', $type = 'message', $success = 0) {
	...
	if($type == 'message') {
		...
		echo "$message ...";
		echo "<br /><br /><br /><a href=\"$url_forward\">سيتم التحويل للصفحات التالية تلقائيا , لكن إن لم يتم التحويل إضغط هنا</a>";
...
function lang($lang_key, $force = true, $replace = array()) {
	$lang = array('filename' => 'إسم الملف',
				'director' => 'المسار',
				'version' => 'الإصدار',
				'time' => 'وقت النسخة الإحتياطية',
				'type' => 'النوع',
				'size' => 'الحجم',
				'db_method' => 'الطريقة',
				'db_volume' => 'العدد',
				'import' => 'إستيراد',
				'different_dbcharset_tablepre' => 'قاعدة البيانات التي تريد إستعادتها والمثبتة حاليا مختلفات في الصيغ{diff} هل أنت متأكد أنك ترغب في الإكمال؟',
				'db_import_tips' => 'تذكر بأن هذه العملية ستقوم بإستبدال بيانات قاعدة البيانات الحالية بالبيانات الجديدة<br />قم بعمل نسخة إحتياطية من قاعدة البيانات الحالية تجنبا لأي مشاكل<br /><span class="red">لا تنسى أن تقوم بحذف الملف restore.php بعد الإنتهاء من العملية</span><br />',
				'db_export_discuz' => 'ديسكاز فقط - بدون اليوسنتر',
				'db_export_discuz_uc' => 'ديسكاز واليوسنتر معا',
				'db_multivol' => 'متعددة',
				'db_import_unzip' => 'فك الضغط',
				'db_export_zip' => 'نسخة مضغوطة',
				'db_zip' => 'ZIP',
				'db_shell' => 'Shell',
				'unknown' => 'غير مهروف',
				'backup_file_unexist' => 'ليس هناك أي ملف لإستعادته',
				'connect_error' => 'الاتصال بقاعدة بيانات فشل، يرجى الاطلاع على ملف تكوين قاعدة بيانات config/config_global.php وأيضا الملف config/config_ucenter.php موجودة وبياناتها صحيحة أم لا',
				'dbcharsetdiff' => ' تعيين الترميز($_config[\'db\'][\'1\'][\'dbcharset\'])',
				'tableprediff' => ' بادئة الجداول($_config[\'db\'][\'1\'][\'tablepre\'])',
				'database_import_multivol_succeed' => 'تم إستيراد البيانات المتعددة للقاعدة بنجاح<br />يرجى تحذين ذاكرة التخزين المؤقتة - الكاش<br /><span class="red">الرجاء حذف الملف restore.php في أقرب وقت ممكن تجنبا للمشاكل والاختراقات</span>',
				'database_import_file_illegal' => 'ملف قاعدة البيانات غير موجود أو ليس هناك صلاحيات : قد يكون السيرفر لا يسمح برفع الملفات الكبيرة',
				'database_import_multivol_prompt' => 'تم إستيراد الجزء الأول من البيانات بنجاح , هناك ملفات أخرى سنقوم بإستيرادها , هل ترغب في إكمال الإستيراد؟',
				'database_import_succeed' => 'تم إستيراد بيانات القاعدة بنجاح<br />يرجى تحذين ذاكرة التخزين المؤقتة - الكاش<br /><span class="red">يرجى حذف الملف restore.php في أقرب وقت ممكن لتجنب المشاكل أو الإختراقات</span>',
				'database_import_format_illegal' => 'صيغة قاعدة البيانات الحالية لا يمكن إستيرادها!',
				'database_import_unzip' => '{info}<br />تم فك ضغط البيانات بنجاح , هل ترغب في إستيراد البيانات؟ بعد الإستيراد سيتم حذف الملفات التي تم فك ضغطها تلقائيا',
				'database_import_multivol_unzip' => '{info}<br />تم فك ضغط الملفات بنجاح , هل ترغب في إكمال عملية إستيراد البيانات؟',
				'database_import_multivol_unzip_redirect' => 'الملف #{multivol} تم فك ضغطه بنجاح , سيتم الإنتقال تلقائيا للخطوة التالية',
				'database_import_confirm' => 'قد يحدث مشاكل في حال كان هناك أخطاء من ملف القاعدة , تأكد من أخذ نسخة إحتياطية من القاعدة الحالية , هل ترغب في الإكمال؟',
				'database_import_confirm_sql' => 'هل أنت متأكد أنك ترغب في إستيراد النسخة الإحتياطية؟',
				'database_import_confirm_zip' => 'هل أنت متأكد أنك ترغب بفك ضغط قاعدة البيانات؟',
				'database_import_multivol_confirm' => 'كل الملفات الفرعية تم فك ضغطها وتجهيزها بنجاح , هل ترغب بإكمال إستيراد البيانات ؟ , بعد فك الضغط سيتم حذف الملفات التي تم فك ضغطها',
				'database_import_multivol_redirect' => 'الملف #{volume} تم إستيراده بنجاح , سيتم إكمال العملية تلقائيا',
				'error_quit_msg' => 'يجب حل المشاكل التالية لكي تستطيع إكمال عملية الإستيراد',
				'restored_error' => 'عملية إستيراد قاعدة البيانات مغلقة حاليا , الرجاء حذف الملف ./data/restore.lock لكي تستطيع إكمال عملية الإستعادة',
			);
